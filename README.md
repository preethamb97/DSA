...
|---|-------|------|------------|-----------|-------------------|
| 1 | **Two Sum** | [`dsa/arrays_strings/two_sum.py`](dsa/arrays_strings/two_sum.py) | Easy | 100% ⭐⭐⭐⭐⭐ | Hash maps, two pointers |
| 2 | **Valid Parentheses** | [`dsa/arrays_strings/valid_parentheses.py`](dsa/arrays_strings/valid_parentheses.py) | Easy | 95% ⭐⭐⭐⭐⭐ | Stack data structure |
| 3 | **Longest Substring** | [`dsa/arrays_strings/longest_substring.py`](dsa/arrays_strings/longest_substring.py) | Medium | 95% ⭐⭐⭐⭐⭐ | Sliding window pattern |
...
|---|-------|------|------------|-----------|--------|
| 6 | **3Sum** | [`dsa/two_pointers/three_sum.py`](dsa/two_pointers/three_sum.py) | Medium | 90% ⭐⭐⭐⭐⭐ | Two pointers |
| 7 | **Container With Most Water** | [`dsa/two_pointers/container_with_most_water.py`](dsa/two_pointers/container_with_most_water.py) | Medium | 95% ⭐⭐⭐⭐⭐ | Two pointers |
| 8 | **Minimum Window Substring** | [`dsa/sliding_window/minimum_window_substring.py`](dsa/sliding_window/minimum_window_substring.py) | Hard | 85% ⭐⭐⭐⭐⭐ | Sliding window |
| 9 | **Binary Search** | [`dsa/sorting_searching/binary_search.py`](dsa/sorting_searching/binary_search.py) | Medium | 90% ⭐⭐⭐⭐⭐ | Binary search |
...
|---|-------|------|------------|-----------|-------------|
| 12 | **Reverse Linked List** | [`dsa/linked_lists/reverse_linked_list.py`](dsa/linked_lists/reverse_linked_list.py) | Easy | 90% ⭐⭐⭐⭐⭐ | Iterative/recursive reversal |
| 13 | **Linked List Cycle** | [`dsa/linked_lists/linked_list_cycle.py`](dsa/linked_lists/linked_list_cycle.py) | Easy | 85% ⭐⭐⭐⭐⭐ | Floyd's cycle detection |
| 14 | **Add Two Numbers** | [`dsa/linked_lists/add_two_numbers.py`](dsa/linked_lists/add_two_numbers.py) | Medium | 95% ⭐⭐⭐⭐⭐ | Linked list manipulation |
...
| # | Topic | File | Difficulty | Frequency | Key Concept |
|---|-------|------|------------|-----------|-------------|
| 17 | **Tree Traversals** | [`dsa/trees/tree_traversals.py`](dsa/trees/tree_traversals.py) | Easy | 100% ⭐⭐⭐⭐⭐ | DFS (in/pre/post), BFS |
...
| # | Topic | File | Difficulty | Frequency | Key Concept |
|---|-------|------|------------|-----------|-------------|
| 20 | **Number of Islands** | [`dsa/graphs/number_of_islands.py`](dsa/graphs/number_of_islands.py) | Medium | 90% ⭐⭐⭐⭐⭐ | DFS/BFS on grid |
...
| # | Topic | File | Difficulty | Frequency | Key Concept |
|---|-------|------|------------|-----------|-------------|
| 23 | **Climbing Stairs** | [`dsa/dynamic_programming/climbing_stairs.py`](dsa/dynamic_programming/climbing_stairs.py) | Easy | 90% ⭐⭐⭐⭐⭐ | DP fundamentals |
| 24 | **Coin Change** | [`dsa/dynamic_programming/coin_change.py`](dsa/dynamic_programming/coin_change.py) | Medium | 85% ⭐⭐⭐⭐⭐ | DP, unbounded knapsack |
| 25 | **House Robber** | [`dsa/dynamic_programming/house_robber.py`](dsa/dynamic_programming/house_robber.py) | Medium | 85% ⭐⭐⭐⭐⭐ | DP, state transitions |
...
| # | Topic | File | Difficulty | Frequency | Key Concept |
|---|-------|------|------------|-----------|-------------|
| 28 | **Permutations** | [`dsa/backtracking/permutations.py`](dsa/backtracking/permutations.py) | Medium | 75% ⭐⭐⭐⭐ | Backtracking, recursion |
...
| # | Topic | File | Difficulty | What You'll Learn |
|---|-------|------|------------|-------------------|
| 39 | **EC2 Management** | [`aws/ec2_examples/manage_instances.py`](aws/ec2_examples/manage_instances.py) | Intermediate | Create, start, stop EC2 instances |
| 40 | **S3 Operations** | [`aws/s3_examples/s3_operations.py`](aws/s3_examples/s3_operations.py) | Intermediate | Upload, download, list S3 objects |
...
| # | Topic | File | Difficulty | What You'll Learn |
|---|-------|------|------------|-------------------|
| 43 | **Rate Limiter** | [`system_design/rate_limiter.py`](system_design/rate_limiter.py) | Advanced | Token bucket, sliding window |
| 44 | **Load Balancer** | [`system_design/load_balancer.py`](system_design/load_balancer.py) | Advanced | Round robin, least connections |
...
python -m dsa.arrays_strings.two_sum
python -m dsa.linked_lists.add_two_numbers
python -m dsa.dynamic_programming.coin_change

# Run web frameworks
python web_frameworks/flask_api/app.py
uvicorn web_frameworks.fastapi_api.main:app --reload
...
|------|-------|----------|------|
| 1-2 | Foundation | 5 problems | Master arrays, strings, hash maps |
| 3-4 | Core Patterns | 6 problems | Master 8 core patterns |
| 5 | Linked Lists | 5 problems | Master linked list operations |
| 6 | Trees | 3 problems | Master tree algorithms |
| 7 | Graphs | 3 problems | Master DFS/BFS |
| 8-9 | Dynamic Programming | 5 problems | Master DP thinking |
| 10 | Backtracking | 3 problems | Master backtracking |
| 11 | Greedy | 2 problems | Understand greedy vs DP |
| 12 | Advanced DS | 2 problems | Master heaps and tries |
| 13 | Design & Strings | 2 problems | System design basics |
| 14 | Web Frameworks | 2 APIs | Build REST APIs |
...
3. **Binary Search** - Sorted data problems
4. **DFS/BFS** - Graph and tree traversal
5. **Dynamic Programming** - Optimization problems
6. **Backtracking** - All possibilities problems
7. **Greedy** - Local optimization
8. **Hash Map** - Frequency counting
9. **Heap** - Top K elements
10. **Trie** - Prefix matching
11. **Topological Sort** - Dependency resolution
12. **Stack/Queue** - Sequence problems
...
- [ ] Use AWS SDK to manage resources
